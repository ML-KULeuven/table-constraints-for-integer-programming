...
\newcommand{\citeNoun}[2]{#1~\emph{et al.}~\cite{#2}}
...
\xymatrix@C=#1@R=#2{
   \xyo{[]}
       ...
       & \xyoo{snk} \\
   & \xyo{\textcolor{blue}{[1]}} \ar@[blue][rd]^{\textcolor{blue}{\be{2}{2}}} &  \\
   & \xyo{\textcolor{red}{[4]}} \ar@[red][r]_{\textcolor{red}{\be{2}{3}}}
       & \xyo{\textcolor{violet}{\scriptscriptstyle[1,2] \scriptscriptstyle[4,3]}} \ar@[violet][ruu]^{\textcolor{violet}{\be{3}{3}}} \\
   & \xyo{[3]} \ar[r]^{\be{2}{2}}
       & \xyo{[3,2]} \ar[ruuu]_{\be{3}{2}} \\
}%
}
